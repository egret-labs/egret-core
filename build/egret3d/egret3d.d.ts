...
declare module egret3d {
    ...
    class ColorTransform {
        ...
        * @platform Web,Native
        */
        copyFrom(ctf: ColorTransform): void;
        /**
        * @language zh_CN
        * 拷贝该颜色变换数据
        * @param ctf 拷贝至目标对象
        ...
        * @platform Web,Native
        */
        copyTo(ctf: ColorTransform): void;
        /**
         * @language zh_CN
         * 设置颜色值
         * @param rgb 0xffffff格式
    ...
    */
    class PropertyAnimController extends EventDispatcher implements IAnimation {
        ...
        */
        ...
        protected _event3D: PropertyAnimEvent3D;
...
declare module egret3d {
    class SkeletonAnimationState implements IAnimationState {
        ...
        * @platform Web,Native
        */
        previousSkeletonPose: SkeletonPose;
        /**
        * @language zh_CN
        * ��ȡ��ǰ֡����
        * @version Egret 3.0
 ...
 */
    class SortUtil {
        static sortZindex(a: Quad, b: Quad): number;
        static sortAB(quads: Quad[]): Quad[];
        static sortBA(quads: Quad[]): Quad[];
    }
}
declare module egret3d {
    /**
    ...
    */
    class QuadStage extends EventDispatcher {
        ...
        */
        ...
        dispatchMuseClick(): void;
        dispatchMuseMove(): void;
        dispatchMouseOut(): void;
        dispatchMouseOver(): void;
    }
}
declare module egret3d.gui {
    class SkinManager {
...
* @platform Web,Native
*/
    class UIElement extends UILayout {
        ...
        getDefaultStyle(style: string): Texture;
        protected getDefaultStyleNameByStyleName(styleName: string): string;
        static getStyleDefinition(): Object;
...
declare module egret3d.gui {
    /**
* @private
* @class egret3d.gui.UIToggleButton
* @classdesc
* @version Egret 3.0
* @platform Web,Native
*/
    class UIToggleButton extends egret3d.gui.UILabelButton {
        constructor();
    }
}
declare module egret3d.gui {
...
*/
    class UIProgressBar extends UIElement {
       ...
       */
        ...
        width: number;
        height: number;
        setBarRect(x: number, y: number, w: number, h: number): void;
        bar: DisplayObject;
...
declare module egret3d {
    class OctahedronSphereGeometry extends Geometry {
        ...
        buildGeomtry(front: boolean): void;
        private CreateOctahedron(vertices, triangles, resolution);
...
declare module egret3d {
    ...
    */
    class UnitParserUtils {
        ...
        static parserConfig(dataConfig: string, type: string): IConfigParser;
...
declare module egret3d {
    ...
    class ParticleParser extends IConfigParser {
         ...
         * @returns ParticleData
         */
        parseJson(text: string): ParticleData;
        parseXml(text: string): ParticleData;
    }
}
declare module egret3d {
    ...
    */
    class QueueLoader extends EventDispatcher {
        ...
        */
        ...
        protected onLoader(e: LoaderEvent3D): void;
        /**
        * @language zh_CN
        * 释放所有数据
        * @version Egret 3.0
...
declare module egret3d {
    ...
    */
    class GrassMethod extends MethodBase {
        ...
        private _time;
        private _grass_wave;
        private _grass_x_span;
        private _grass_y_span;
        private _grass_z_span;
        private _grass_wave_big;
        private _grass_range;
        private _grass_wave_x;
        private _grass_wave_z;
        private _grassData;
        ...
        * @platform Web,Native
        */
        updateGrass(wave: number, x_span: number, y_span: number, z_span: number, wave_big: number, range: number, wave_x: number, wave_z: number): void;
        /**
        * @language zh_CN
        * 更新草受到挤压的数据
