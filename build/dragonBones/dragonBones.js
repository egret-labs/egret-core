...
(function (dragonBones) {
    ...
    var ObjectDataParser = (function (_super) {
        ...
        ObjectDataParser.prototype.parseTextureAtlasData = function (rawData, textureAtlasData, scale) {
            ...
            dragonBones.DragonBones.assert(rawData !== undefined);
            if (rawData === null) {
        ...
        BaseObject._returnObject = function (object) {
            ...
            if (pool.length < maxCount) {
                if (!object._isInPool) {
                    ...
                    dragonBones.DragonBones.assert(false, "The object is already in the pool.");
                }
            }
            else {
            }
...
(function (dragonBones) {
    ...
    var SkinData = (function (_super) {
        ...
        SkinData.prototype.addDisplay = function (slotName, value) {
            var slotDisplays = slotName in this.displays ? this.displays[slotName] : (this.displays[slotName] = []); // TODO clear prev
...
(function (dragonBones) {
    ...
    DragonBones.assert = console.assert;
...
(function (dragonBones) {
    ...
    var EgretFactory = (function (_super) {
        ...
        Object.defineProperty(EgretFactory, "factory", {
             ...
             */
            get: function () {
                if (EgretFactory._factroy === null) {
                    EgretFactory._factroy = new EgretFactory();
                }
                return EgretFactory._factroy;
            },
            enumerable: true,
            configurable: true
        });
...
(function (dragonBones) {
    ...
    var EgretSlot = (function (_super) {
        ...
        function EgretSlot() {
             ...
             * @language zh_CN
             */
            _this.transformUpdateEnabled = true;
                ...
                if (currentTextureAtlas !== null) {
                    if (currentTextureData.texture === null) {
                        ...
                        if (currentTextureData.rotated) {
                            currentTextureData.texture.$initData(currentTextureData.region.x, currentTextureData.region.y, subTextureHeight, subTextureWidth, 0, 0, subTextureHeight, subTextureWidth, textureAtlasWidth, textureAtlasHeight, currentTextureData.rotated);
                        }
                        else {
                            currentTextureData.texture.$initData(currentTextureData.region.x, currentTextureData.region.y, subTextureWidth, subTextureHeight, 0, 0, subTextureWidth, subTextureHeight, textureAtlasWidth, textureAtlasHeight, false);
                        }
                    }
                    if (meshData !== null) {
