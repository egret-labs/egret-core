declare namespace dragonBones {
    ...
    class DragonBones {
        ...
        static readonly assert: (test?: boolean, message?: string, ...optionalParams: any[]) => void;
...
declare namespace dragonBones {
    ...
    class SkinData extends BaseObject {
        ...
        protected _onClear(): void;
        addDisplay(slot: SlotData, value: DisplayData | null): void;
...
declare namespace dragonBones {
    ...
    class AnimationData extends BaseObject {
         ...
         * @private
         */
        readonly meshTimelines: Map<Array<TimelineData>>;
        /**
         * @private
         */
...
declare namespace dragonBones {
    ...
    abstract class BaseFactory {
        ...
        changeSkin(armature: Armature, name: string, exclude?: Array<string> | null): void;
        /**
...
declare namespace dragonBones {
    ...
    class EgretFactory extends BaseFactory {
         ...
         * @private
         */
        static eventManager: EgretArmatureDisplay;
        /**
         * 一个可以直接使用的全局 WorldClock 实例.
         * @version DragonBones 5.0
         * @language zh_CN
