...
var UpgradeCommand_1_0_4 = (function () {
    ...
    UpgradeCommand_1_0_4.prototype.upgradeTo_1_0_4 = function () {
        ...
        var releasePath = file.join(params.getProjectRoot(), "launcher/release.html");
        var txt = file.read(releasePath);
        txt = txt.replace("<base href=\"../\"/>", "");
        file.save(releasePath, txt);
        file.remove(file.join(params.getProjectRoot(), "libs/egret.d.ts"));
...
//# sourceMappingURL=UpgradeCommand_1_0_4.js.map