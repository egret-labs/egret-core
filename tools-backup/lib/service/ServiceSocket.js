...
var ServiceSocket = (function (_super) {
    ...
    function ServiceSocket(socket) {
        var _this = this;
        _super.call(this);
        this.egretMessageParser = new EgretMessageBody();
        this.socket = socket;
    ...
    ServiceSocket.prototype.send = function (object) {
        var msg = EgretMessageBody.toMessage(object);
        try {
    ...
    ServiceSocket.prototype.onData = function (text) {
        var _this = this;
        this.egretMessageParser.pushData(text, function (data) { return _this.onGotMessage(data); });
    };
...
var EgretMessageBody = (function () {
    function EgretMessageBody() {
    }
    EgretMessageBody.toMessage = function (data) {
        var json = JSON.stringify(data);
        var length = json.length;
        var header = EgretMessageBody.EGRETHEADER + ":" + length + "\n";
        var msg = header + json;
        return msg;
    };
    EgretMessageBody.prototype.pushData = function (text, msgCallback) {
        if (text.indexOf(EgretMessageBody.EGRETHEADER) == 0) {
    ...
    EgretMessageBody.EGRETHEADER = "EGRET-MSG";
    return EgretMessageBody;
})();
