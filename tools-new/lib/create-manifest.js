...
var globals;
(function (globals) {
    function joinEgretDir(current, arg0) {
    }
    globals.joinEgretDir = joinEgretDir;
    function log(code) {
        console.log(code);
    }
    globals.log = log;
 ...
 * 创建manifest列表
 */
function create(srcPath, createAll, referenceInfo, hasSwan1, fileList) {
    hasSwan = !!hasSwan1;
    srcPath = escapeSrcPath(srcPath);
 ...
 */
function getManifest(srcPath, fileList) {
    resetCache();
