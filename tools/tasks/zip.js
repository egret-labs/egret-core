...
function zip(sourcePath) {
    return __awaiter(this, void 0, void 0, function () {
        var relativePath, compilerPath, tempPath, contentBuffer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    compilerPath = path.join(egret.root, "tools/lib/zip/EGTZipTool_v1.0.2.js");
                    tempPath = path.join("", '1.zip');
                ...
                case 1:
                    ...
                    contentBuffer = fs.readFileSync(tempPath);
