...
declare namespace ts {
    ...
    function isASICandidate(node: Node, sourceFile: SourceFileLike): boolean;
    ...
    function createPackageJsonInfo(fileName: string, host: LanguageServiceHost): PackageJsonInfo | undefined;
