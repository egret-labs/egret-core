...
(function (egret) {
    ...
    locale_strings[1116] = "警告! tsconfig.json 中的编译选项 'target' 只支持 'ES5'";
    locale_strings[1117] = "警告! tsconfig.json 中的编译选项 'module' 只支持 'commonjs'";
    locale_strings[1118] = "配置文件 tsconfig.json 发生变化，请使用: egret build -e 命令重新编译";
