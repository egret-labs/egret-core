...
locale_strings[1116] = "Warning! The compiler option 'target' in tsconfig.json only support the 'ES5'";
locale_strings[1117] = "Warning! The compiler option 'module' in tsconfig.json only support the 'commonjs'";
locale_strings[1118] = "The file tsconfig.json had benn changed, please use command: egret build -e to recompile the project";
